...
std::string name = "your application name"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
std::string ownerid = "your ownerid"; // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
std::string secret = "your app secret"; // app secret, the blurred text on licenses tab and other tabs
